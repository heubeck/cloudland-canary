...
In another shell, produce some load that results in http 500s:

```shell
# Instruct the examiner to respond with http 500 over the next 90 seconds
hey -c 2 -q 2 -z 90s "http://localhost/examine?delay=100..500&status=500"
```
